...
| ---------------- | -------------------------------------------------------- | -------------------------- | ----- |
| AuraDB           | `aura://`, `auras://`, `aura+tcp://`                     | Aura Wire Protocol         | Native, highest-performance target |
...
await Aura.connect("auras://db.example.com:7171/app", models=[User])   # AuraDB over TLS
```
